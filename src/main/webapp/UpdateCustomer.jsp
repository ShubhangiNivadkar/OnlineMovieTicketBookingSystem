...
<tr>
<th>First Name</th>
<td><input name="firstName" value="${custoObj.firstName }" type="text" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="fname" style="color: red">*</span></td>
</tr>

<tr>
<th>Last Name</th>
<td><input name="lastName" value="${custoObj.lastName }" type="text" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="lname" style="color: red">*</span></td>
</tr>

<tr>
<th>Contact</th>
<td><input name="contact" value="${custoObj.contact }" type="number" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="contact" style="color: red">*</span></td>
</tr>

<tr>
<th>Email</th>
<td><input name="email" value="${custoObj.email }" type="email" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="email" style="color: red">*</span></td>
</tr>

<tr>
<th>Address</th>
<td><input name="address" value="${custoObj.address }" type="text" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="address" style="color: red">*</span></td>
</tr>

<tr>
<th>Password</th>
<td><input name="password" value="${custoObj.password }" type="password" class="validateMe form-control form-control-sm" onblur="validate(this)"></td>
<td><span id="password" style="color: red">*</span></td>
</tr>

<tr>
<td><input type="reset" value="Reset" class="btn btn-warning"></td> 
<td><input type="submit" value="Submit" class="btn btn-info" onclick="return validateWithClass()"></td> 
</tr>
</table>
</form>
